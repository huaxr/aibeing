...
from interact.llm.codeinterpreter.agents import OpenAIFunctionsAgent
from interact.llm.codeinterpreter.chains import (
    aget_file_modifications,
    aremove_download_link,
    get_file_modifications,
    remove_download_link,
)
from interact.llm.codeinterpreter.chat_history import CodeBoxChatMessageHistory
from interact.llm.codeinterpreter.config import settings
from interact.llm.codeinterpreter.parser import CodeAgentOutputParser, CodeChatAgentOutputParser
from interact.llm.codeinterpreter.prompts import code_interpreter_system_message
from interact.llm.codeinterpreter.schema import (
    CodeInput,
...
class CodeInterpreterSession:
    ...
    def _choose_llm(
        ...
        if "gpt" in model:
            ...
            from interact.llm.codeinterpreter.llm import FakeAgent
            return FakeAgent()
        else:
