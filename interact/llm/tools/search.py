...
os.environ["SERPAPI_API_KEY"] = "39070f9d5f6135617d2f3aa9455617c1fccd8d9313ab711f43e245159118ca7c"
...
search = GoogleAPIWrapper()

def test(query, **kwargs) -> str:
    print(query, kwargs)
    return "aaaaaa"
